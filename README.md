...
ただ、curlコマンドのオプションの種類は今回出てきたもののみ意味を調べてみたが、他のオプションの使用方法などまだ理解が及んでいない。また、POSTMANのリクエストの際のボディの記載は自分1人では何を書いたら良いかわかっていない状態で、ヘッダにどんな種類があるのかなどまだまだ調べることもたくさんあり、今後も地道に行っていく必要を感じた。  
